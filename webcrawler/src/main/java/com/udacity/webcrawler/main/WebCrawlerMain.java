...
public final class WebCrawlerMain {
  ...
  private void run() throws Exception {
    ...
    // Write the crawl results to a JSON file (or System.out if the file name is empty) crawl output
    ...
    // Write the profile data to a text file (or System.out if the file name is empty) profile output
